...
These compatibility bytes passed exact GX10 staging/tests and same-packet protected-copy inference but are not yet installed. The production timer remains disabled and the original terminal failure remains immutable evidence.
