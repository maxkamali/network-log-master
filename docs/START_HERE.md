...
8. Component-specific documentation for the active task. For current managed local-reasoning work, read `docs/REASONING_PACKETS.md`, `docs/LOCAL_REASONING.md`, `docs/MANAGED_REASONING.md`, and `components/gx10/README.md`.
